...
```{r embedded populate slots, echo=T, include=T, message=T, eval=F}
require(phyloseq)
require(ggstatsplot)
require(ggplot2)
require(here)
...
```{r IGC_Richness Analysis,echo=F,include=F,message=F, eval=F}
require(phyloseq)
...
### VIRGO Richness
```{r Virgo_Richness Analysis,echo=F,include=F,message=F,eval=F}
require(phyloseq)
require(DataExplorer)
require(compareGroups)
require(ggstatsplot)
