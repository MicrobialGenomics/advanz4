...
vars=c("CD4 value","CD8 value", "4+38+DR+","8+38+DR+", "PCR", "IL-6", "TNF-a", "sCD14","HIV Viral load [lab]", "CMV Viral Load")
...
metadata_final <- 
  metadata_final %>% 
  mutate(weight = case_when(link_var == "C007" & long_var == 48 ~ 69.7,
