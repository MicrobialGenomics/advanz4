...
basal_mre <- metar:::filter_samples(mre = mymre, sample_ids =  basal_meta$SampleID)
...
## Alpha diversity
We'll assess first the correlation between inflammation at baseline and the BL microbiome.
...
We'll start looking at the deltas, as the BL microbiome might influence how much inflammation changes.
...
Anyhow, let's plot the inflammation changes by gene richness:
