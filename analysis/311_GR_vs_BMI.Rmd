...
deltas_gr0_abs <- 
  ...
  labs(title = "Absolute", subtitle = paste("ANOVA p =", test_gr0_abs)) +
  theme_light()
...
deltas_gr0_rel <- 
  ...
  geom_smooth(method = "glm", aes(fill = cat_var)) +
  theme_light() +
  labs(title = "Relative", subtitle = paste("ANOVA p =", test_gr0_rel)) +
  theme(axis.title.y = element_blank())
...
deltas_gr_abs <- 
  ...
  geom_point() +
  geom_smooth(method = "glm", aes(fill = cat_var)) +
  labs(title = "Absolute", subtitle = paste("ANOVA p =", test_gr_abs)) +
  theme_light()
...
deltas_gr_rel <- 
  ...
  geom_smooth(method = "glm", aes(fill = cat_var)) +
  theme_light() +
  labs(title = "Relative", subtitle = paste("ANOVA p =", test_gr_rel)) +
  theme(axis.title.y = element_blank())
