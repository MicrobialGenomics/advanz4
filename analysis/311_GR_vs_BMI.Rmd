...
ggpubr::ggarrange(plot_delta_abs, plot_delta_rel)  


```
Both absolute and relative increases seem fairly unimodal with a slight skew to the left. There seems to be a local minima in the relative deltas, but not enough to justfy a split. 
