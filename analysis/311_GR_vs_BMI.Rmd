...
```{r delta_cors_96, warning=FALSE, message=F}
test_gr0_abs <-
  delta_bmi_df %>%
...
Seems like the biggest differences happened at 24th week, after which both groups behave roughly the same. Let's test this:
